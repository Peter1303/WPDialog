...
public class WPDialog
{
    ...
    private class Builder {
        ...
        private void setCustomView(Dialog dialog){
			//控件实例化
			wp_title=(TextView)dialog.findViewById(R.id.wp_title);
			wp_message=(TextView)dialog.findViewById(R.id.wp_message);
            wp_ok=(TextView)dialog.findViewById(R.id.wp_ok);
			wp_neutral=(TextView)dialog.findViewById(R.id.wp_neutral);
			wp_cancel=(TextView)dialog.findViewById(R.id.wp_cancel);
			
			layout=(LinearLayout)dialog.findViewById(R.id.wp_bg);
			okLayout=(LinearLayout)dialog.findViewById(R.id.wp_ok_bg);
			neutralLayout=(LinearLayout)dialog.findViewById(R.id.wp_neutral_bg);
			cancleLayout=(LinearLayout)dialog.findViewById(R.id.wp_cancle_bg);
			
			frame=(FrameLayout)dialog.findViewById(R.id.wp_view);
